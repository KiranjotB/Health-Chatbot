...
class cbfs(param.Parameterized):
    ...
    def __init__(self,  **params):
        ...
        self.panels = []
        self.loaded_file = "docs/health_conditions.pdf"
...
# Define the directory containing PDF files and output filename for disease
pdf_directory = "docs/health_conditions"
output_pdf = "health_conditions.pdf"
...
def merge_pdfs(directory, output_filename):
    ...
    merger.close()
    print(f"PDFs merged into {output_filename}")
# Define the directory containing PDF files and output filename
pdf_directory = "docs/health_conditions"
output_pdf = "health_conditions.pdf"
